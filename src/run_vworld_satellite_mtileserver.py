...
# ✅ argparse로 --map_port, --min_zoom, --mbtiles 받기
parser = argparse.ArgumentParser()
parser.add_argument('--map_port', type=int, default=8092, help='Port to run the server on')
parser.add_argument('--min_zoom', type=int, default=10, help='Minimum zoom level allowed for fallback')
parser.add_argument('--mbtiles', type=str, default="./vworld_satellite_korea.mbtiles", help='Path to MBTiles file')
...
# ✅ 타일 요청 엔드포인트
@app.route("/tiles/vworld_satellite_korea/<int:z>/<int:x>/<int:y>.jpeg")
